            ...
            <div class="quiz-card">
                ...
                <div class="quiz-card-footer">
                    <?php if ($role === 'siswa'): ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <a href="<?= url('quiz/questions/' . $q['id']) ?>" class="btn btn-sm btn-secondary"><i class="fas fa-cog"></i> Kelola Soal</a>
                        <span style="font-size: 12px; color: var(--text-muted);"><?= $q['attempt_count'] ?? 0 ?> peserta</span>
                    <?php endif; ?>
                </div>
            </div>
        <?php endforeach; ?>
